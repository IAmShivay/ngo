...
import { BookOpen, Globe, HandHelping, Heart, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="block md:hidden relative">
          ...
          <div className="absolute top-1/2 left-0 right-0 z-10 flex justify-between transform -translate-y-1/2">
            <button className="swiper-button-prev bg-white/50 rounded-full p-1 shadow-md hover:bg-white/75 transition">
              <ChevronLeft className="w-4 h-4 text-gray-800" />
            </button>
            <button className="swiper-button-next bg-white/50 rounded-full p-1 shadow-md hover:bg-white/75 transition">
